...
interface ListaTareasEstado {
  tareas: GestionesInterfaz[];
  modalVisible: boolean;
  tareaSeleccionada?: GestionesInterfaz;
...
class ListaTareas extends Component<any, ListaTareasEstado> {
  state: ListaTareasEstado = {
    tareas: [],
    modalVisible: false,
